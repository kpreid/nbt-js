...
//
// CommonJS module support and BinaryReader added by Sijmen Mulder
...
(function() {
	...
	this.BinaryReader = function(buffer, bigEndian) {
		var pos = 0;
		var parser = new binary.BinaryParser(bigEndian, true)
		...
		this.int = function(bits, signed) {
			return parser.decodeInt(getBits(bits), bits, signed);
		};

		this.float = function(precisionBits, exponentBits) {
			var data = getBits(precisionBits + exponentBits);
			return parser.decodeFloat(data, precisionBits, exponentBits);
		};
